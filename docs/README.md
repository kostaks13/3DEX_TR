# Docs – Yardımcı dokümanlar

```
┌──────────────────────────────────────────────────────────────────────────────┐
│  API referansı · Hızlı başlangıç · Terimler · SSS · Sorun giderme · Changelog │
└──────────────────────────────────────────────────────────────────────────────┘
```
...
| Dosya | Açıklama |
|-------|----------|
| [VBA_API_REFERENCE.md](VBA_API_REFERENCE.md) | Sık kullanılan API imzaları ve Help kaynaklarına yönlendirme |
| [QUICK_START.md](QUICK_START.md) | İlk 5 dakikada tek sayfa hızlı başlangıç |
| [CHEATSHEET.md](CHEATSHEET.md) | Tek sayfa hızlı referans (zincir, parametre, hata, döngü) |
| [GLOSSARY.md](GLOSSARY.md) | Terimler sözlüğü (Part, Parameter, Nothing, Update vb.) |
